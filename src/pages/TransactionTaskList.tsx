...
const ChecklistColumnB = () => (
  <>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      <SmallChecklistItem label="Date:" className="pl-2" blankWidth="w-10" disableCheckbox />
      <SmallChecklistItem label="Requested Payment from Seller:" className="pl-2" blankWidth="w-10" disableCheckbox />
      <SmallChecklistItem label="Seller Paid:" className="pl-4" blankWidth="w-10" disableCheckbox />
      ...
      <SmallChecklistItem label="Sent to Buyer:" className="pl-2" blankWidth="w-16" disableCheckbox />
      <SmallChecklistItem label="Fully Signed" className="pl-4" />
    </div>
    <SectionHeader>11b. ADDITIONAL INFORMATION</SectionHeader>
    <div className="mb-1 flex flex-col gap-0.5">
      <span className="text-[0.63rem]">Name: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Phone: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Email: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Resale Cert Expiration: <span className="border-b border-gray-300 inline-block w-12"></span></span>
      <span className="text-[0.63rem]">Cost: <span className="border-b border-gray-300 inline-block w-20"></span></span>
    </div>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      <span className="text-[0.63rem]">Township: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Phone: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Email: <span className="border-b border-gray-300 inline-block w-20"></span></span>
      <span className="text-[0.63rem]">Cost: <span className="border-b border-gray-300 inline-block w-20"></span></span>
    </div>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      ...
      <SmallChecklistItem label="Scheduled:" blankWidth="w-12" disableCheckbox />
      ...
      <div className="pl-2 flex flex-col gap-0.5">
        ...
        <SmallChecklistItem label="Repairs Completed:" className="pl-2" blankWidth="w-10" disableCheckbox mini />
        <SmallChecklistItem label="Notify Lender:" className="pl-2" blankWidth="w-10" disableCheckbox mini />
...
const ChecklistColumnC = () => (
  <>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      <span className="text-[0.63rem]">Appraiser: <span className="border-b border-gray-300 inline-block w-16"></span></span>
      <span className="text-[0.63rem]">Date of Inspection: <span className="border-b border-gray-300 inline-block w-14"></span></span>
      <span className="text-[0.63rem]">Phone: <span className="border-b border-gray-300 inline-block w-16"></span></span>
      <span className="text-[0.63rem]">Email: <span className="border-b border-gray-300 inline-block w-20"></span></span>
    </div>
    <SectionHeader>14. MORTGAGE COMMITMENT</SectionHeader>
    <div className="mb-1 flex flex-col gap-0.5">
      <SmallChecklistItem label="Due Date:" blankWidth="w-12" disableCheckbox />
      <SmallChecklistItem label="Requested:" blankWidth="w-12" disableCheckbox />
      <SmallChecklistItem label="Received:" blankWidth="w-12" disableCheckbox />
      <SmallChecklistItem label="Sent to Seller" />
    </div>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      ...
      <SmallChecklistItem label="Received" />
      <SmallChecklistItem label="Sent to Buyer:" blankWidth="w-12" disableCheckbox />
    </div>
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      ...
      <SmallChecklistItem label="Documents Sent to Client:" blankWidth="w-12" disableCheckbox mini />
      <SmallChecklistItem label="Documents Signed Early at Title Company:" blankWidth="w-14" disableCheckbox mini />
    </div>
    <SectionHeader>19. ESCROW CHECK</SectionHeader>
    <div className="mb-1 flex flex-col gap-0.5">
      <SmallChecklistItem label="Request Escrow Check:" blankWidth="w-12" disableCheckbox />
    ...
    <div className="mb-1 flex flex-col gap-0.5">
      <span className="text-[0.63rem]">Preferred Time: <span className="border-b border-gray-300 inline-block w-12"></span></span>
      <span className="text-[0.63rem]">Preferred Location: <span className="border-b border-gray-300 inline-block w-16"></span></span>
    </div>
  ...
  return (
    <div className="w-full flex flex-col items-center pt-4 pb-2 print:shadow-none bg-white">
      <div className="max-w-[8.5in] min-h-[11in] bg-white shadow border border-gray-300 print:shadow-none print:border-0 px-3 py-2 flex flex-col gap-1">
        ...
        <div className="border-2 border-gray-800 grid grid-cols-12 gap-0.5 p-1 items-center mb-1 text-[0.62rem] bg-yellow-50">
          {[
          ...
          <div className="col-span-4 flex flex-col gap-1 border-l border-gray-300 pl-2">
            <div className="font-semibold text-[0.62rem]">KW ASA Signatures:</div>
        ...
        {/* Three column layout */}
        <div className="flex-grow grid grid-cols-3 gap-x-3 gap-y-1">
          <div className="flex flex-col gap-1 text-[0.59rem]">{<ChecklistColumnA />}</div>
          <div className="flex flex-col gap-1 text-[0.59rem]">{<ChecklistColumnB />}</div>
          <div className="flex flex-col gap-1 text-[0.59rem]">{<ChecklistColumnC />}</div>
        </div>
